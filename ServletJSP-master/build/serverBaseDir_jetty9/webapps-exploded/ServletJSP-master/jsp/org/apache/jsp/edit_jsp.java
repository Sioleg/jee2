...
public final class edit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("<body>\n");
      tp1.Personne name = null;
      synchronized (request) {
        name = (tp1.Personne) _jspx_page_context.getAttribute("name", PageContext.REQUEST_SCOPE);
        if (name == null){
          try {
            name = (tp1.Personne) java.beans.Beans.instantiate(this.getClass().getClassLoader(), "tp1.Personne");
          } catch (ClassNotFoundException exc) {
            throw new InstantiationException(exc.getMessage());
          } catch (Exception exc) {
            throw new ServletException("Cannot create bean of class " + "tp1.Personne", exc);
          }
          _jspx_page_context.setAttribute("name", name, PageContext.REQUEST_SCOPE);
        }
      }
      out.write('\n');
      if (_jspx_meth_c_out_0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("<a href=\"formBean.html\">Retour</a>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_out_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${name.GetNom()}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
