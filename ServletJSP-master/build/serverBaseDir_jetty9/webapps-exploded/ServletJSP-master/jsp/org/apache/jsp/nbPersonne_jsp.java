...
public final class nbPersonne_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (request) {
        liste = (ArrayList) _jspx_page_context.getAttribute("liste", PageContext.REQUEST_SCOPE);
        if (liste == null){
          try {
            liste = (ArrayList) java.beans.Beans.instantiate(this.getClass().getClassLoader(), "ArrayList");
          } catch (ClassNotFoundException exc) {
            throw new InstantiationException(exc.getMessage());
          } catch (Exception exc) {
            throw new ServletException("Cannot create bean of class " + "ArrayList", exc);
          }
          _jspx_page_context.setAttribute("liste", liste, PageContext.REQUEST_SCOPE);
        }
      }
      out.write("\n");
      out.write("\t\n");
  ...
  private boolean _jspx_meth_c_out_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${liste}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
